<template>
	<view>
		<toprow2 titleval="修改手机号"></toprow2>
	...
	export default{
		...
		methods:{
			...
			getCodeOne(flag){
				...
				uni.request({
				    url: _self.$httpUrl+'api/Usersup/sendCode', 
					method:"POST",
					data:{
						mobile:phoneNum
					},
			...
			updatePhone(flag){
				...
				uni.request({
				    url: _self.$httpUrl+'api/Usersup/modifyPhone', 
					method:"POST",
					data:{
						code:pcode,
...
<style>
	@import url("css/update_phone.css");
