<template>
	...
	<view class="city-select">
		<scroll-view :scroll-top="scrollTop" scroll-y="true" class="city-select-main" id="city-select-main">
			...
			<!-- 预留搜索-->
			<view class="serch_line">
				<view class="site">{{ activeCity[formatName] }}</view>
				<!-- <image class="arrow_cube" :src="getImgSrc('home/home4.png')" mode="widthFix"></image> -->
				<image class="search_cube" :src="getImgSrc('home/home11.png')" mode="widthFix"></image>
				<input @input="keyInput" placeholder="请输入您要搜索的城市" />
			</view>
			...
			setTimeout(() => {
				query
					...
					.boundingClientRect(data => {
						...
						data ? (that.scrollTop = data.top - 70) : void 0
					})
					.exec()
			}, 0)
		},
